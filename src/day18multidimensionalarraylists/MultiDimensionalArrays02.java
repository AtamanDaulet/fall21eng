...
public class MultiDimensionalArrays02 {
	//Find the maximum element in 2 dimensional array
		...
		/*
		 	1)Convert 2 dimensional array to 1 dimensional array then sort the elements in ascending order
		 	 and get the last element
		 	
		 	2)We will get the lowest value then if a value is greater than the lowest value, 
		 	I will assign the value to the lowest one
		 */
