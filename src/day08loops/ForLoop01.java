...
//Type code to print "Hello!" 10 times on the console
      ...
      //Type code to print all unique characters on the console from a given String
        ...
        String str = "samaaammme";
        String notUnique="";
        
        String strLowerCase = str.toLowerCase();
        
        for (int i = 0; i < str.length(); i++) {
        	String single = strLowerCase.charAt(0)+"";
        	strLowerCase = strLowerCase.substring(1);
        	if(strLowerCase.indexOf(single) != -1 && notUnique.indexOf(single) == -1 ) {
        		notUnique = notUnique.concat(single);
        	}			
		}
        
        String result = str.toLowerCase();
        for (int i = 0; i < notUnique.length(); i++) {
        	String s2 = notUnique.charAt(i)+"";        	
