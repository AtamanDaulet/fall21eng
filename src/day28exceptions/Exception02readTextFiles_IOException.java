...
*/
public class Exception02readTextFiles_IOException {
	...
	public static void readTextFiles1() throws IOException {
			///fall21eng/src/day28exceptions/TestFile01
		FileInputStream fis = new FileInputStream("src/day28exceptions/TestFile01");
	...
	public static void readTextFiles2() {
		...
		try {
			...
			fis = new FileInputStream("src/day28exceptions/TestFile01");
