...
//	public static final = its default for variable
	String MAKE = "Samsung"; // = public static final String MAKE = "Samsung";
	
	public abstract void electronicAC();
	
	public void climateAC();  //two methods is same =void climateAC();
